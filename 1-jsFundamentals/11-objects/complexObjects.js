...
console.log(netflix);
console.log(netflix.season1.seasonInfo.epsisodeInfo[3].episodeName);

// Pick an episode to log in the terminal
// Using dot notation, walk through the netflix object and 
// print off both the episode number and the episode name

console.log(netflix.season1.seasonInfo.epsisodeInfo[4].episode + ' ' + netflix.season1.seasonInfo.epsisodeInfo[4].episodeName);
...
// Object.keys return an array consisting of the keys in our object
...
Object.keys(garden).forEach(key => {
    if (key == g) {  // keys in the garden object
